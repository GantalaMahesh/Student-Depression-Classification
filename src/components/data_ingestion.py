...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            df.loc[:, 'Financial Stress'] = df['Financial Stress'].replace(
                '?', np.nan)
            df.loc[:, 'Financial Stress'] = df['Financial Stress'].fillna(
                df['Financial Stress'].mode()[0])
            df.loc[:, 'Financial Stress'] = df['Financial Stress'].astype(
                float)
